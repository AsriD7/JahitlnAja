...
<head>
    ...
    <!-- Favicons -->
    <link href="{{asset('Store')}}/assets/img/favicon.png" rel="icon">
    <link href="{{asset('Store')}}/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
    ...
    <!-- Vendor CSS Files -->
    <link href="{{asset('Store')}}/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="{{asset('Store')}}/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
    <link href="{{asset('Store')}}/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
    <link href="{{asset('Store')}}/assets/vendor/aos/aos.css" rel="stylesheet">
    <link href="{{asset('Store')}}/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
    <link href="{{asset('Store')}}/assets/vendor/drift-zoom/drift-basic.css" rel="stylesheet">

    <!-- Main CSS File -->
    <link href="{{asset('Store')}}/assets/css/main.css" rel="stylesheet">
...
<body class="index-page">
    ...
    <!-- Vendor JS Files -->
    <script src="{{asset('Store')}}/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="{{asset('Store')}}/assets/vendor/php-email-form/validate.js"></script>
    <script src="{{asset('Store')}}/assets/vendor/swiper/swiper-bundle.min.js"></script>
    <script src="{{asset('Store')}}/assets/vendor/aos/aos.js"></script>
    <script src="{{asset('Store')}}/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
    <script src="{{asset('Store')}}/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
    <script src="{{asset('Store')}}/assets/vendor/glightbox/js/glightbox.min.js"></script>
    <script src="{{asset('Store')}}/assets/vendor/drift-zoom/Drift.min.js"></script>
    <script src="{{asset('Store')}}/assets/vendor/purecounter/purecounter_vanilla.js"></script>
