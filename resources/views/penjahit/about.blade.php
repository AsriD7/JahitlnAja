      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="content-card">
              <div class="card-image">
                <img src="{{asset('FashionStore')}}/assets/img/about/about-portrait-16.webp" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
            <div class="content-card">
              <div class="card-image">
                <img src="{{asset('FashionStore')}}/assets/img/about/about-portrait-4.webp" alt="" class="img-fluid">
              </div>
              <div class="card-content">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
            <div class="content-card">
              <div class="card-image">
                <img src="{{asset('FashionStore')}}/assets/img/about/about-portrait-1.webp" alt="" class="img-fluid">
              </div>
              <div class="card-content">
                ...
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="{{asset('FashionStore')}}/assets/img/person/person-m-7.webp" class="profile-img" alt="">
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="{{asset('FashionStore')}}/assets/img/person/person-m-7.webp" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="{{asset('FashionStore')}}/assets/img/person/person-f-8.webp" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Sara Wilsson</h3>
                        <span>Designer</span>
                      </div>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="{{asset('FashionStore')}}/assets/img/person/person-f-8.webp" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="{{asset('FashionStore')}}/assets/img/person/person-m-9.webp" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Matt Brandon</h3>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="{{asset('FashionStore')}}/assets/img/person/person-m-9.webp" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="{{asset('FashionStore')}}/assets/img/person/person-f-10.webp" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Jena Karlis</h3>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="{{asset('FashionStore')}}/assets/img/person/person-f-10.webp" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
